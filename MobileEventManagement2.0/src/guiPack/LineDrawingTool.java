 ...
 * 
 */
public class LineDrawingTool extends javax.swing.JFrame {
    ...
    public LineDrawingTool(MainForm parent) {
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LINE DRAWING TOOL");
...
// TODO add your handling code here:
        if (!loaded) {
            new MessageBox(this, "Select An Input Image First!").setVisible(true);
            return;
        }
