...
public class ScaleImagesForPresentationSlides extends javax.swing.JFrame {
    MainForm parent;
    BufferedImage bi = new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB);
    boolean scaled=false;
    
    public ScaleImagesForPresentationSlides(MainForm parent) {
        this.parent = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SCALE IMAGES FOR WELCOME SLIDES (500 x 500)");
