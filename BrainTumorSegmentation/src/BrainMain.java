...
import com.sd.bts.security.licence.Encryt;
...
class LicenceForm extends JFrame implements ActionListener {
	...
	JLabel licenceLbl=new JLabel("Enter Licence Key:");
	JTextField licenceTxt=new JTextField();
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getActionCommand()=="Submit")
		{
			...
			String licenceValue = licenceTxt.getText();
